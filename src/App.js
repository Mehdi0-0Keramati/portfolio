...
const App = () => {
    ...
    const { loading, setLoading, currentMode, setCurrentMode, currentColor, setCurrentColor, currentLang, setCurrentLang, i18n } = useStateContext()
    ...
    return (
        <div className={`${currentMode === "dark" ? "dark" : ""} rtl:font-soltan font-robotoBold `}>
